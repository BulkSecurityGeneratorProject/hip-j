...
public class RegionResourceTest {
    ...
    private static final Integer DEFAULT_PROMISE_DATE_BUFFER = 0;
    private static final Integer UPDATED_PROMISE_DATE_BUFFER = 1;
    ...
    public void initTest() {
        ...
        region.setPromise_date_buffer(DEFAULT_PROMISE_DATE_BUFFER);
    }
    ...
    public void createRegion() throws Exception {
        ...
        assertThat(testRegion.getPromise_date_buffer()).isEqualTo(DEFAULT_PROMISE_DATE_BUFFER);
    }
    ...
    public void getAllRegions() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions"))
                ...
                .andExpect(jsonPath("$.[*].promise_date_buffer").value(hasItem(DEFAULT_PROMISE_DATE_BUFFER)));
    }
    ...
    public void getRegion() throws Exception {
        ...
        restRegionMockMvc.perform(get("/api/regions/{id}", region.getId()))
            ...
            .andExpect(jsonPath("$.promise_date_buffer").value(DEFAULT_PROMISE_DATE_BUFFER));
    }
    ...
    public void updateRegion() throws Exception {
        ...
        region.setPromise_date_buffer(UPDATED_PROMISE_DATE_BUFFER);
        ...
        assertThat(testRegion.getPromise_date_buffer()).isEqualTo(UPDATED_PROMISE_DATE_BUFFER);
    }
