 ...
 */
@Entity
@Table(name = "MASTER_CHACHA")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_chacha implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_chacha master_chacha = (Master_chacha) o;

        if ( ! Objects.equals(id, master_chacha.id)) return false;
