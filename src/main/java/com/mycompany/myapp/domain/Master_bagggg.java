 ...
 */
@Entity
@Table(name = "MASTER_BAGGGG")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_bagggg implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_bagggg master_bagggg = (Master_bagggg) o;

        if ( ! Objects.equals(id, master_bagggg.id)) return false;
