 ...
 */
@Entity
@Table(name = "MASTER_BAGGG")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_baggg implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_baggg master_baggg = (Master_baggg) o;

        if ( ! Objects.equals(id, master_baggg.id)) return false;
