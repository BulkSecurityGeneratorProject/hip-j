 ...
 */
@Entity
@Table(name = "MASTER_CHEF")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_chef implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_chef master_chef = (Master_chef) o;

        if ( ! Objects.equals(id, master_chef.id)) return false;
