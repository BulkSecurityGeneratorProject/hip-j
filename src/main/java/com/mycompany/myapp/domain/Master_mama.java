 ...
 */
@Entity
@Table(name = "MASTER_MAMA")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_mama implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_mama master_mama = (Master_mama) o;

        if ( ! Objects.equals(id, master_mama.id)) return false;
