 ...
 */
@Entity
@Table(name = "MASTER_ROSHI")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Master_roshi implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Master_roshi master_roshi = (Master_roshi) o;

        if ( ! Objects.equals(id, master_roshi.id)) return false;
